...
XBD_EVENTS = {'EVT001', 'EVT003', 'EVT005', 'EVT008', 'EVT009', 'EVT010', 'EVT012'}
    ...
    for aoi in aois:
        ...
        for t in range(1, n_epochs):
            ...
            try:
                ...
                # Building count check (xBD events only — spectral polygons aren't building footprints)
                if t == 1 and event_id in XBD_EVENTS:
